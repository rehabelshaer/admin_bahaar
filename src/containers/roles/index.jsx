...
const Countries = () => {
  ...
  //       <div
  //         style={{ color: "#646D82", cursor: "pointer" }}
  //         className="d-flex"
  //       ></div>
  //     ),
  //   },
  ...
  return (
    <>
      <IndexMain
        ...
        // head table content
        addRowURL={
          getPermissions("roles", "create") ? config.routes.add : false
        }
        // head filters table
        filters={filters}
        // columns table content
        editRowURL={
          getPermissions("roles", "update") ? config.routes.edit : false
        }
        showRowURL={config.routes.show}
        deleteRow={{ status: getPermissions("roles", "delete"), deleteRecord }}
        action={
          getPermissions("roles", "delete") ||
          getPermissions("roles", "update") ||
          true
        }
