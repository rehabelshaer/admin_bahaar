  ...
  return (
    <>
      <IndexMain
        ...
        // head table content
        addRowURL={
          getPermissions("requestTypes", "create") ? config.routes.add : false
        }
        // head filters table
        filters={filters}
        // columns table content
        editRowURL={
          getPermissions("requestTypes", "update") ? config.routes.edit : false
        }
        // showRowURL={config.routes.show}
        deleteRow={{
          status: getPermissions("requestTypes", "delete"),
          deleteRecord,
        }}
        action={
          getPermissions("requestTypes", "delete") ||
          getPermissions("requestTypes", "update") ||
          false
        }
        generalCols={generateCols(["title_en", "title_ar"])}
        options={[]}
