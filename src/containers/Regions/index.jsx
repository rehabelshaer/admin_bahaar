  ...
  return (
    <>
      <IndexMain
        ...
        // head table content
        addRowURL={getPermissions("regions", "create")?config.routes.add:false}
        // head filters table
        filters={filters}
        // columns table content
        editRowURL={getPermissions("regions", "update")?config.routes.edit:false}
        //   showRowURL={config.routes.show}
        deleteRow={{ status: getPermissions("regions", "delete"), deleteRecord }}
        action={(getPermissions("regions", "delete")||getPermissions("regions", "update"))||false}
