  ...
  return (
    <>
      <IndexMain
        ...
        // head table content
        addRowURL={getPermissions("permissions", "create")?config.routes.add:false}
        // head filters table
        filters={filters}
        // columns table content
        editRowURL={getPermissions("permissions", "update")?config.routes.edit:false}
         // showRowURL={config.routes.show}
         deleteRow={{ status: getPermissions("permissions", "delete"), deleteRecord }}
         action={(getPermissions("permissions", "delete")||getPermissions("permissions", "update"))||false}
