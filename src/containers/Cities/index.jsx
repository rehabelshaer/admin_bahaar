  ...
  return (
    <>
      <IndexMain
        ...
        // head table content
        addRowURL={
          getPermissions("countries", "create") ? config.routes.add : false
        }
        // head filters table
        filters={filters}
        // columns table content
        editRowURL={
          getPermissions("countries", "update") ? config.routes.edit : false
        }
        // showRowURL={config.routes.show}
        deleteRow={{
          status: getPermissions("countries", "delete"),
          deleteRecord,
        }}
        action={
          getPermissions("countries", "delete") ||
          getPermissions("countries", "update") ||
          false
        }
        generalCols={generateCols([
          ...
          {
            key: "country",
            content: (text, record) => <div>{record.country.name_en}</div>,
          },
          {
            key: "created_at",
