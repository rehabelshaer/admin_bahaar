              ...
              {loading ? (
                ...
                <Row>
                  <Col span={24}>
                    ...
                    >
                      <Form.Item
                        label={<IntlMessages id="hours" />}
                        hasFeedback
                      >
                        {getFieldDecorator("hours", {
                          initialValue: cat ? cat.hours : "",
                          rules: [
                            {
                              required: true,
                              message: <IntlMessages id="hours" />,
                            },
                          ],
                      ...
                      <Form.Item
                        label={<IntlMessages id="refund percentage" />}
                        hasFeedback
                      >
                        {getFieldDecorator("refund_percentage", {
                          initialValue: cat ? cat.refund_percentage : "",
                          rules: [
                            {
                              required: true,
                              message: <IntlMessages id="refund_percentage" />,
                            },
                          ],
                        })(<Input type="text" size="large" />)}
                      </Form.Item>
