...
li.ant-menu-item.ant-menu-item-only-child.ant-menu-item-selected {
  border-radius:10px;
  box-shadow:0px 0px 3px 0px #E7C795;
}
.ant-menu:not(.ant-menu-horizontal) .ant-menu-item-selected {
  background: #E7C795!important;
  border-radius:10px;
  box-shadow: 0px 0px 3px 0px #E7C795;
}
...
//   filter:invert(1)
// }
// .MuiGrid-root , .MuiGrid-item ,img , button ,.bizcharts,ant-breadcrumb{
//   filter:invert(1)
